...
const {
  ...
  remoteParticipants.forEach((participant, participantSid) => {
    ...
    // 🔥 CRITICAL FIX: Get LIVE track states from LiveKit
  ...
  displayName: displayName,
  isLocal: false,
  // 🔥 CRITICAL FIX: Use LIVE states from LiveKit (overrides stale database states)
...
const combinedStreams = useMemo(() => {
  ...
  }, [screenSharing, livekitLocalIsScreenSharing, handleToggleScreenShare, showNotificationMessage]);
  // ==========================================================================
  // RECORDING HANDLERS
  // ==========================================================================
...
const handleSaveRecordingName = useCallback(async (recordingName) => {
...
<RecordingNameDialog
  ...
  defaultName={
    pendingRecordingData
      ? `${meetingData?.title || 'Meeting'}_${new Date().toLocaleDateString('en-US').replace(/\//g, '-')}`
      : ''
  }
/>
